...
type DataCategory = 'default' | 'error' | 'transaction' | 'replay' | 'security' | 'attachment' | 'session' | 'internal' | 'profile' | 'monitor' | 'feedback' | 'statsd' | 'unknown';
...
declare const SDK_VERSION = "8.0.0-alpha.8";
